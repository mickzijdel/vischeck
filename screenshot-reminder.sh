...
cat <<JSON
{"hookSpecificOutput":{"hookEventName":"PostToolUse","additionalContext":"You edited a view/template file. Use the \`verifier-screenshot\` skill to visually verify the change.${DARK_MODE_NOTE}${INTERACTIVE_NOTE}"}}
JSON
exit 0
